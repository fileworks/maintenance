...
enabled as Renovate's vulnerability signal; Dependabot version updates and
automated security-update PRs remain disabled so Renovate is the only update
author.
...
Renovate reads those alerts and creates the security-fix PRs itself.
